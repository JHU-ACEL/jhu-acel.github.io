...
<div class="student-container" onclick="toggleBio('bio-nunna')">
  ...
  <div id="bio-nunna" class="student-bio">
    ...
    <p>Rahul is a second-year Robotics MSE Student with a B.S. in Computer Engineering from Fresno State. He is interested in using generative machine learning methods for robot navigation in unseen extreme environments.</p>
  </div>
</div>
...
<div class="student-container" onclick="toggleBio('bio-lozano')">
  <img src="../assets/img/Lozano.jpeg" alt="Federico Lozano Cuadra" style="width: 187.5px; height: 187.5px; object-fit: cover; border-radius: 8px;">
  <br><strong>Federico Lozano Cuadra</strong>
  <div id="bio-lozano" class="student-bio">
    <h4>PhD Student</h4>
    <p>Federico is a visiting Fulbright PhD student from the University of Málaga (UMA). He holds an M.Sc. in telecommunication engineering from UMA. During his PhD, he has collaborated with ESA and completed two research stays at NASA JPL in 2025 and 2026. His research focuses on machine learning for space communication networks, and he is also interested in entrepreneurship.</p>
  </div>
</div>
...
<ul class="alumni-list">
  <li><em>Rahul Kalpana Anwardeen (2025—2026) </em></li>
</ul>